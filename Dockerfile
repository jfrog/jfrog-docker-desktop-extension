...
LABEL org.opencontainers.image.title="JFrog" \
    ...
    com.docker.extension.changelog="<p>New Features<ul><li>Saving logs to files.</li></ul>Improvements<ul><li>Removed cursor design.</li></ul>Bug Fixes<ul><li>Trying to save both password and access token, which is not allowed.</li></ul></p>"
