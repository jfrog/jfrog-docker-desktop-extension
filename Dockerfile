...
LABEL org.opencontainers.image.title="JFrog" \
    ...
    com.docker.extension.changelog="<p>New Improvements📈</p><ul><li>Improved encryption for user credentials</li></ul><p>Bug Fixes 🛠</p><ul><li>Fix login issues for Windows users</li><li>Fix the free enviornment link</li></ul>"
